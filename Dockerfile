...
RUN curl -O -L https://github.com/alitariq4589/github-runner-riscv/releases/download/v2.329.0_riscv/actions-runner-linux-riscv64-2.329.0.tar.gz && \
    tar xzf actions-runner-linux-riscv64-2.329.0.tar.gz && rm actions-runner-linux-riscv64-2.329.0.tar.gz
