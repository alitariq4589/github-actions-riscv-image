...
# Download
RUN curl -L -O https://github.com/alitariq4589/github-runner-riscv/releases/download/v${RUNNER_VERSION}_riscv/actions-runner-linux-riscv64-${RUNNER_VERSION}.tar.gz

# Extract
RUN tar -xvzf actions-runner-linux-riscv64-${RUNNER_VERSION}.tar.gz

# Cleanup
RUN rm actions-runner-linux-riscv64-${RUNNER_VERSION}.tar.gz
